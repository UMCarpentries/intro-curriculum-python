...
source: Rmd
title: "Writing Reports with Markdown"
teaching: 105
exercises: 30
questions:
- "How can I make reproducible reports using Markdown?"
...
- "To be aware of the various report formats that can be rendered using Markdown."
...
### Contents
1. [What is R Markdown and why use it?](#why-use-markdown)
1. [Creating a reports directory](#creating-a-reports-directory)
1. [Creating a Markdown file](#creating-a-markdown-file)
1. [Basic components of Markdown](#basic-components-of-markdown)
    + [Header](#header)
...
## What is R Markdown and why use it? {##why-use-markdown}
...
[7] First, read in the CO2 dataset. You can use the code from the [R for data analysis]({{ page.root }}/04-python-data-analysis) lesson to clean the CO2 data.
